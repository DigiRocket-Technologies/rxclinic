...
//     // Get the latest meeting details from the most recent answers
//     const meetingDetailsAnswer =
//       answers[-1]?.[17]?.nestedAnswers?.find(
//         (na) => na.question === "Meeting Details"
//       )?.answer[0] || '"" | ""';

//     console.log("Meeting details answer:", meetingDetailsAnswer); // Debug log

//     const [datePart = "", timePart = ""] = meetingDetailsAnswer
//       .split("|")
...
//     console.log("Final Data being submitted:", finalData); // Debug log
...
//   const handleFormComplete = async () => {
//     // Get the latest meeting details
//     const meetingDetailsAnswer =
//       answers[-1]?.[17]?.nestedAnswers?.find(
//         (na) => na.question === "Meeting Details"
//       )?.answer[0] || '"" | ""';
