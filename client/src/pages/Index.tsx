...
import { PillIcon, StethoscopeIcon, MessageSquareTextIcon, MicroscopeIcon, SyringeIcon, CalendarClockIcon } from "lucide-react";
...
const Index = () => {
  ...
  const services = [
      ...
      subservices: [
        { 
          ...
          subItems: [
            ...
            { id: "2-1-3", title: "Pinworms and Threadworms", icon: "digestive" },
            { id: "2-1-4", title: "Nausea and Vomiting in Pregnancy", icon: "digestive" }
          ]
        },
        { 
          id: "2-2", 
        ...
        { 
          ...
          subItems: [
            ...
            { id: "2-3-3", title: "Skin Irritations (Dermatitis)", icon: "skin" },
            { id: "2-3-4", title: "Insect Bites and Hives", icon: "skin" },
            { id: "2-3-5", title: "Diaper Rash", icon: "skin" },
            { id: "2-3-6", title: "Tick Bite - Lyme Disease Prevention", icon: "skin" }
          ]
        },
        { 
          id: "2-4", 
          ...
          subItems: [
            { id: "2-4-1", title: "Menstrual (Period) Cramps", icon: "reproductive" },
            { id: "2-4-2", title: "Vaginal Yeast Infection", icon: "reproductive" },
            { id: "2-4-3", title: "Urinary Tract Infection", icon: "reproductive" }
          ]
        },
        { 
          id: "2-5", 
          ...
          subItems: [
            ...
            { id: "2-5-2", title: "Influenza Treatment or Prevention", icon: "flu" }
          ]
        }
      ]
    },
    { 
      ...
      subservices: [
        { id: "3-1", title: "Telemedicine Clinic (Covered by OHIP+)", icon: "telemedicine" }
      ]
    },
    { 
      id: 4, 
    ...
    { 
      ...
      subservices: [
        { id: "5-1", title: "Flu Vaccine", icon: "vaccine" },
        { id: "5-2", title: "COVID-19 Vaccine", icon: "vaccine" },
        { id: "5-3", title: "COVID-19 + Flu Vaccine", icon: "vaccine" },
        { id: "5-4", title: "Hepatitis A", icon: "vaccine" },
        { id: "5-5", title: "Hepatitis A and B", icon: "vaccine" },
        { id: "5-6", title: "Hepatitis B", icon: "vaccine" },
        { id: "5-7", title: "HPV", icon: "vaccine" },
        { id: "5-8", title: "Pneumococcal disease", icon: "vaccine" },
        { id: "5-9", title: "Shingles", icon: "vaccine" },
        { id: "5-10", title: "Vitamin B12", icon: "vaccine" }
      ]
    },
    { 
      id: 6, 
  ...
  const filteredServices = services.filter(service => 
    ...
    service.subservices?.some(sub => 
      typeof sub.title === 'string' && sub.title.toLowerCase().includes(searchQuery.toLowerCase()) ||
      sub.subItems?.some(item => item.title.toLowerCase().includes(searchQuery.toLowerCase()))
    )
  );
  ...
  return (
    <div className="min-h-screen bg-neutral-50 flex flex-col items-center px-4 py-8 md:py-16">
      <div className="w-full max-w-2xl mx-auto">
        ...
        <div className="mb-10">
          <h1 className="text-2xl md:text-3xl font-medium text-center mb-2">Select a Service</h1>
          <p className="text-gray-600 text-center text-sm md:text-base">Choose from the list of services to get started</p>
        </div>
